...
class Man(object):
    ...
    def __init__(self, ground_height: Point3D) -> None:
        ...
        self.left_leg = Leg(start=self.body.get_corner(DL) + RIGHT*0.1, thigh_length=self.thigh_length, shin_length=self.shin_length,
                            right=True, color=BLUE)
        self.right_leg = Leg(start=self.body.get_corner(DR) + LEFT*0.1, thigh_length=self.thigh_length, shin_length=self.shin_length,
